<?php 
/**
 * \file      creation_compte_etudiant.php
 * \author    Fabien Pinel
 * \version   1.0
 * \date      24 Février 2015
 * \brief     Page de traitement du formulaire d'inscription d'un etudiant. 
 *            Vérification des informations et création du compte dans la bdd. (table membre) 
 *            et upload du cv
 *
 * \details  
 */
           		...
           		if ($resultat){
					...
					// Insertion dans la base de donnée
           			$req = $bdd->exec('	INSERT INTO membre(nom, prenom, mail, pass, promotion, parcours, motcles1, motcles2)
           				VALUES("' .$_POST['nom']. '", "' .$_POST['prenom']. '", "' .$_POST['mail']. '", "' .md5($_POST['passEtudiant']). '", "' .$_POST['promotion'].'", "", "'.$_POST['motcles1'].'", "'.$_POST['motcles2'].'")');
           			if($req){
