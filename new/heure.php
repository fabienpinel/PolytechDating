<?php 
	...
	echo'<form method="post" action="validation.php" role="form" class="form">';
	$heures = array('14h00', '14h20', '14h40', '15h00', '15h20', '16h00', '16h20', '16h40', '17h00', '17h20');
	for($i = 0;$i < 9;$i++){
			if(!$donnes[$heures[$i]]){
				echo '<input type="radio" name="heure" value="' .$heures[$i]. '" id="' .$heures[$i]. '"  /> <label for="' .$heures[$i]. '">De ' .$heures[$i]. ' &agrave; '.$heures[$i+1]. '</label>';
			}
